...
extern (C) {
	...
	void  function(lua_State *L, const(char)* libname, const luaL_Reg *l, int nup) luaL_openlib;
	//C	 LUALIB_API void (luaL_register) (lua_State *L, const char *libname,
	//C									 const luaL_Reg *l);
	void  function(lua_State *L, const(char)* libname, const luaL_Reg *l) luaL_register;
	...
	//C															   size_t *l);
	const(char)* function(lua_State *L, int numArg, size_t *l) luaL_checklstring;
	//C	 LUALIB_API const char *(luaL_optlstring) (lua_State *L, int numArg,
	//C											   const char *def, size_t *l);
	const(char)* function(lua_State *L, int numArg, const(char)* def, size_t *l) luaL_optlstring;
	...
	void  function(lua_State *L, int t, int _ref) nothrow luaL_unref;
	...
	//C													   const char *r);
	const(char)* function(lua_State *L, const(char)* s, const(char)* p, const(char)* r) luaL_gsub;

	//C	 LUALIB_API const char *(luaL_findtable) (lua_State *L, int idx,
	//C											  const char *fname, int szhint);
	const(char)* function(lua_State *L, int idx, const(char)* fname, int szhint) luaL_findtable;
